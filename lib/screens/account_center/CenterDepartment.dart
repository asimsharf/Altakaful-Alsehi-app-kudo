...
import 'package:takaful/screens/account_center/CenterServices.dart';

class CenterDepartment extends StatefulWidget {
  int center_id;
  String center;
  CenterDepartment({this.center_id, this.center});
  @override
  _CenterDepartmentState createState() => _CenterDepartmentState();
}

class _CenterDepartmentState extends State<CenterDepartment> {
  ...
  Future<List<ModelDepartment>> getCenters() async {
    String link =
        "http://23.111.185.155:4000/takaful/api/center/${widget.center_id}/department";
    var res = await http
