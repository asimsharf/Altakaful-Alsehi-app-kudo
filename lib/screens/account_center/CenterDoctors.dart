...
import 'package:takaful/screens/account_center/CenterDoctorsDetails.dart';

class CenterDoctors extends StatefulWidget {
  int center_id;
  int department_id;
  int doc_id;
  String center;
...
class _DoctorsState extends State<CenterDoctors> {
  ...
  Future<List<ModelDoctors>> getCenters() async {
    String link =
        "http://23.111.185.155:4000/takaful/api/center/${widget.center_id}/doctor";
    var res = await http
  ...
  Widget _buildProductList() {
    Widget DoctorsList;
    if (_Model_Doctors.length > 0) {
      DoctorsList = new ListView.builder(
          ...
          return new GestureDetector(
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Text(
                                      'عدد الزوار اليومي  ${DoctorsObj.visits_per_day}زائر ',
                                      style: TextStyle(
                                        fontSize: 10.0,
                                        color: Colors.red,
                                        fontFamily: ArabicFonts.Cairo,
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Text(
                                      '  سعر الإستشارة ${DoctorsObj.consult_price} ريال ',
                                      style: TextStyle(
                                        fontSize: 15.0,
                                        color: Colors.green,
                                        fontFamily: ArabicFonts.Cairo,
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => CenterDoctorsDetails(
