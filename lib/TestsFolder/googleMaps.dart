...
//
//class GoogleMapsGeo extends StatefulWidget {
//  GoogleMapsGeo({Key key, this.title}) : super(key: key);
//
//  final String title;
//
//  @override
//  _GoogleMapsGeoState createState() => new _GoogleMapsGeoState();
//}
//
//const API_KEY = "AIzaSyBU7XxG0zI-MQzLnfWheKFTkWx-jTm19E0";
//
//class _GoogleMapsGeoState extends State<GoogleMapsGeo> {
//  MapView mapView;
...
//      } else {
//        mapView.setMarkers([
//          new Marker("1", "selected", currentLocation.latitude,
...
//      mapView.setMarkers(
//          [new Marker("1", "selected", location.latitude, location.longitude)]);
